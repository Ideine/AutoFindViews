...
if [ ! -f $TOOLS_DIR/packages.config ]; then
    ...
    curl -Lsfo $TOOLS_DIR/packages.config https://raw.githubusercontent.com/cake-build/resources/58b167843706c5f8176f5fe9ba04ef2f703bafe7/packages.config #http://cakebuild.net/download/bootstrapper/packages
    if [ $? -ne 0 ]; then
